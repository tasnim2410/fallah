...
export const DICT = {
  ar: {
    ...
    'trust.direct.title': 'من المزارع مباشرة',
    'trust.direct.desc': 'من دون وسطاء، بأسعار المزرعة',
    'trust.cash.title': 'الدفع عند الاستلام',
    'trust.cash.desc': 'نقدًا عند تسلّم الطلب',
    'trust.fast.title': 'التوصيل في اليوم نفسه',
    'trust.fast.desc': 'للطلبات المؤكَّدة قبل الساعة 14:00',
