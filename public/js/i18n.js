...
export const DICT = {
  ar: {
    ...
    'form.pinLocked': 'اكتب العنوان أولاً، ولو بشكل تقريبي، لتتمكّن من تحديد الموقع.',
    'form.mapUrl': 'رابط خرائط غوغل',
    'form.mapUrlPh': 'https://maps.app.goo.gl/…',
    'form.mapUrlHint': 'افتح موقعك في تطبيق خرائط غوغل، ثمّ الصق رابط المشاركة هنا.',
    'form.or': 'أو',
  ...
  fr: {
    ...
    'form.pinLocked': "Écrivez d'abord l'adresse, même approximative, pour pouvoir placer le point.",
    'form.mapUrl': 'Lien Google Maps',
    'form.mapUrlPh': 'https://maps.app.goo.gl/…',
    'form.mapUrlHint': 'Ouvrez votre position dans Google Maps, puis collez ici le lien de partage.',
    'form.or': 'ou',
