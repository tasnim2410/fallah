...
export const DICT = {
  ar: {
    ...
    'form.pinUseLocation': 'استخدم موقعي الحالي',
    ...
    'form.pinSearchLabel': 'ابحث عن عنوان أو مكان',
    'form.pinSearchPh': 'ابحث عن عنوان أو مكان…',
    'form.pinSearchEmpty': 'لا توجد نتائج لهذا البحث.',
    ...
    'admin.secContact': 'التواصل',
    'admin.shopPhone': 'رقم الهاتف الظاهر للزبائن',
    'admin.shopPhonePh': 'مثال: 20 123 456',
    ...
    'admin.pickupMapUrl': 'رابط خرائط غوغل',
    'admin.pickupMapUrlPh': 'https://maps.app.goo.gl/…',
    'admin.pickupMapUrlHint': 'افتح موقع الاستلام في تطبيق خرائط غوغل، ثمّ الصق رابط المشاركة هنا.',
    'admin.pickupMapOr': 'أو',
    'admin.pickupMap': 'الموقع على الخريطة',
    'admin.pickupMapHelp': 'حرّك الخريطة حتى تصبح العلامة فوق نقطة الاستلام، ثمّ اضغط «تأكيد الموقع». يظهر للزبون كزر يفتح خرائط غوغل.',
    ...
    'promo.trigger.contains': 'عندما يحتوي الطلب على منتج',
    ...
    'promo.scope.product': 'منتج واحد أو أكثر',
    ...
    'promo.triggerContains': 'عند طلب {product}',
    ...
    'promo.condContains': 'الطلب يحتوي على {product}',
    ...
    'fulfil.pickupMap': 'افتح في خرائط غوغل',
    ...
    'p.salePrice': 'سعر التخفيض (بالدينار)',
    'p.salePriceHint': 'اتركه فارغًا إن لم يكن على المنتج تخفيض.',
    ...
    'err.max_invalid': 'أقصى كمية يجب أن تكون 0.5 على الأقل.',
    ...
    'err.pin_required': 'حدّد موقعك على الخريطة لمتابعة الطلب.',
    'err.pin_invalid': 'الموقع المحدَّد خارج تونس. حرّك الخريطة إلى عنوانك.',
    'err.map_url_invalid': 'رابط غير صالح.',
    ...
    'err.pickup_pin_invalid': 'موقع غير صالح على الخريطة.',
    'err.pickup_map_url_invalid': 'رابط غير صالح.',
    'err.shop_phone_invalid': 'رقم هاتف غير صالح.',
    'err.sale_price_invalid': 'سعر تخفيض غير صالح.',
    'err.sale_price_above_price': 'سعر التخفيض يجب أن يكون أقلّ من سعر الوحدة.',
  ...
  fr: {
    ...
    'form.pinUseLocation': 'Utiliser ma position actuelle',
    ...
    'form.pinSearchLabel': 'Rechercher une adresse ou un lieu',
    'form.pinSearchPh': 'Rechercher une adresse ou un lieu…',
    'form.pinSearchEmpty': 'Aucun résultat pour cette recherche.',
    ...
    'admin.secContact': 'Contact',
    'admin.shopPhone': 'Numéro de téléphone affiché aux clients',
    'admin.shopPhonePh': 'Exemple : 20 123 456',
    ...
    'admin.pickupMapUrl': 'Lien Google Maps',
    'admin.pickupMapUrlPh': 'https://maps.app.goo.gl/…',
    'admin.pickupMapUrlHint': "Ouvrez le lieu de retrait dans Google Maps, puis collez ici le lien de partage.",
    'admin.pickupMapOr': 'ou',
    'admin.pickupMap': 'Point sur la carte',
    'admin.pickupMapHelp': 'Déplacez la carte pour amener le repère sur le lieu de retrait, puis appuyez sur « Valider le point ». Le client verra un bouton pour ouvrir Google Maps.',
    ...
    'promo.trigger.contains': 'Quand la commande contient un produit',
    ...
    'promo.scope.product': 'Un ou plusieurs produits',
    ...
    'promo.triggerContains': 'Avec {product} dans la commande',
    ...
    'promo.condContains': 'La commande contient {product}',
    ...
    'fulfil.pickupMap': 'Ouvrir dans Google Maps',
    ...
    'p.salePrice': 'Prix soldé (en dinars)',
    'p.salePriceHint': "Laissez vide si le produit n'est pas en promotion.",
    ...
    'err.max_invalid': 'La quantité maximale doit être d\'au moins 0,5.',
    ...
    'err.pin_required': 'Placez votre position sur la carte pour continuer.',
    'err.pin_invalid': 'Le point placé est hors de Tunisie. Déplacez la carte sur votre adresse.',
    'err.map_url_invalid': 'Lien invalide.',
    ...
    'err.pickup_pin_invalid': 'Point invalide sur la carte.',
    'err.pickup_map_url_invalid': 'Lien invalide.',
    'err.shop_phone_invalid': 'Numéro de téléphone invalide.',
    'err.sale_price_invalid': 'Prix soldé invalide.',
    'err.sale_price_above_price': "Le prix soldé doit être inférieur au prix à l'unité.",
