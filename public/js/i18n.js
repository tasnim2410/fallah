...
export const DICT = {
  ar: {
    ...
    'admin.deliveryPrice': 'سعر التوصيل (بالمليم)',
    'admin.freeDeliveryFrom': 'التوصيل مجّاني ابتداءً من (بالمليم)',
    ...
    'promo.secTrigger': 'الشرط',
    'promo.secReward': 'الخصم',
    ...
    'promo.triggerProductLabel': 'المنتج المطلوب شراؤه',
    'promo.triggerQtyLabel': 'الكمية المطلوبة',
    'promo.triggerAmountLabel': 'مجموع الطلب المطلوب (بالمليم)',
    ...
    'promo.scope.product': 'منتجًا واحدًا',
    'promo.scope.cart': 'كامل الطلب',
    'promo.rewardProductLabel': 'المنتج المشمول بالخصم',
    'promo.rewardPercentLabel': 'نسبة الخصم (%)',
    'promo.rewardAmountLabel': 'مبلغ الخصم (بالمليم)',
    ...
    'promo.rewardProductsLabel': 'المنتجات المشمولة بالخصم',
    'promo.rewardProductsHint': 'اختر منتجًا أو أكثر. يمكن أن تكون غير المنتج الذي يفتح العرض.',
    ...
    'err.delivery_invalid': 'سعر توصيل غير صالح (من 0 إلى 100000 مليم).',
    'err.free_delivery_invalid': 'مبلغ غير صالح (من 0 إلى 1000000 مليم).',
  ...
  fr: {
    ...
    'admin.deliveryPrice': 'Prix de la livraison (en millimes)',
    'admin.freeDeliveryFrom': 'Livraison offerte à partir de (en millimes)',
    ...
    'promo.secTrigger': 'Condition',
    'promo.secReward': 'Remise',
    ...
    'promo.triggerProductLabel': 'Produit à acheter',
    'promo.triggerQtyLabel': 'Quantité requise',
    'promo.triggerAmountLabel': 'Montant de commande requis (en millimes)',
    ...
    'promo.scope.product': 'Un produit',
    'promo.scope.cart': 'Toute la commande',
    'promo.rewardProductLabel': 'Produit remisé',
    'promo.rewardPercentLabel': 'Remise (%)',
    'promo.rewardAmountLabel': 'Montant de la remise (en millimes)',
    ...
    'promo.rewardProductsLabel': 'Produits remisés',
    'promo.rewardProductsHint': 'Choisissez un produit ou plusieurs. Ils peuvent différer du produit qui déclenche l\'offre.',
    ...
    'err.delivery_invalid': 'Prix de livraison invalide (de 0 à 100000 millimes).',
    'err.free_delivery_invalid': 'Montant invalide (de 0 à 1000000 millimes).',
